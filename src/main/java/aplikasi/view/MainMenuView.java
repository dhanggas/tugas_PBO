...
public class MainMenuView extends javax.swing.JFrame {
    ...
    public void setEnabledMenuPelanggan(Boolean aktif) {
        ...
        this.btnPelanggan.setVisible(false); //hanya untuk menghilangkan
        this.mniPelanggan.setEnabled(aktif);
        this.mniPelanggan.setVisible(false); //hanya untuk menghilangkan
    }
    ...
    public void setEnabledMenuPenjualan(Boolean aktif) {
        ...
        this.btnPenjualan.setVisible(false); //hanya untuk menghilangkan

        this.mniPenjualan.setEnabled(aktif);
        this.mniPenjualan.setVisible(false); //hanya untuk menghilangkan
    }
    ...
    public void setEnabledMenuLaporan(Boolean aktif) {
        ...
        this.mniLapPembelian.setEnabled(aktif);
        this.mniLapPenjualan.setVisible(false); //hanya untuk menghilangkan
    ...
    private void initComponents() {
        ...
        btnPesananPembelian.setText("Pesanan Pembelian (PO)");
        ...
        btnBayarPesananPembelian.setText("Ambil PO");
        ...
        mniPesanPembelian.setText("Pesanan Pembelian (PO)");
        ...
        mniAmbilPesanPembelian.setText("Ambil PO ");
        ...
        mniLapPembelian.setText("All Pembelian");
        mniLapPembelian.setEnabled(false);
        mniLapPembelian.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mniLapPembelianActionPerformed(evt);
            }
        });
    ...
    JasperDesign JasDes;
    private void mniLapPembelianActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniLapPembelianActionPerformed
       try{
        String dbname = "jdbc:mysql://localhost:3306/sipmi?zeroDateTimeBehavior=convertToNull";
           Class.forName("org.mariadb.jdbc.Driver");
           Connection con = DriverManager.getConnection(dbname, "root", "admin");
           File reprt = new File("src/main/resources/laporan/lap_pembelian.jrxml");
    ...
    }//GEN-LAST:event_mniLapPembelianActionPerformed
